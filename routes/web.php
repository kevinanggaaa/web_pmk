...
Route::prefix('admin')->group(function () {
    ...
    Route::destroy('/landingPageHome/{home}', [FrontEndController::class, 'deleteHome'])->name('landingPage.deleteHome');
    ...
    Route::destroy('/landingPageVisiMisi/{VisiMisi}', [FrontEndController::class, 'deleteVisiMisi'])->name('landingPage.deleteVisiMisi');
    ...
    Route::destroy('/landingPageAbout/{about}', [FrontEndController::class, 'deleteAbout'])->name('landingPage.deleteAbout');
    ...
    Route::destroy('/landingPageRenungan/{renungan}', [FrontEndController::class, 'deleteRenungan'])->name('landingPage.deleteRenungan');
});
